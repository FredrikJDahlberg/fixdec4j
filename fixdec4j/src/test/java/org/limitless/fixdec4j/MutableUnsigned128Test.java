...
public class MutableUnsigned128Test {
    ...
    private static void add(final MutableUnsigned128 value1, final MutableUnsigned128 value2, final MutableUnsigned128 result) {
    ...
    private static void subtract(final MutableUnsigned128 value1, final MutableUnsigned128 value2, final MutableUnsigned128 result) {
        System.out.format("%016x%016x - %016x%016x = %016x%016x%n",
            value1.highBits(), value1.lowBits(), value2.highBits(), value2.lowBits(),
            result.highBits(), result.lowBits());
    ...
    private static void multiply(final MutableUnsigned128 value1, final MutableUnsigned128 value2, final MutableUnsigned128 result) {
        System.out.format("%016x%016x * %016x%016x = %016x%016x%n",
            value1.highBits(), value1.lowBits(), value2.highBits(), value2.lowBits(),
            result.highBits(), result.lowBits());
    ...
    private static void divide(final MutableUnsigned128 value1, final MutableUnsigned128 value2, final MutableUnsigned128 result) {
        System.out.format("%016x%016x / %016x%016x = %016x%016x%n",
            value1.highBits(), value1.lowBits(), value2.highBits(), value2.lowBits(),
            result.highBits(), result.lowBits());
...
// of(0, 1).divide(0); -> arithmetic
    ...
    public void checkHashCodes() {
        assertEquals(0, of(0, 0).hashCode());
        assertEquals(32, of(1, 1).hashCode());
    }
